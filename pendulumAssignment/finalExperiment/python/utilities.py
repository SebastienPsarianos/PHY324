...
sizeInfo = {}
with open(f"{directory}/data/sizes.csv") as sizeData:
    sizeInfo["20g"], sizeInfo["100g"], sizeInfo["200g"], sizeInfo["500g"] = [Mass(*[float(i) for i in line.strip('\n').split(',')]) for line in sizeData.readlines() if "Weight" not in line]
